<div class="centercontent">
  <div class="pageheader">
    ...
    <span class="pagedesc">Add Type Information</span>
    <ul class="hornav">
      <li class="current"><a href="#basic">Basic Information</a></li>
      <li><a href="#branchlist">Type List</a></li>
    </ul>
  </div>
  <!--pageheader-->
  ...
  <div id="contentwrapper" class="contentwrapper">
    <div id="basic" class="subcontent">
      ...
      <?php echo form_open('Admin/add_new_loan',array('class'=>"stdform stdform2",'id'=>"add_new_type"));?>
       <p>
        <label>Select Category</label>
        <span class="field">
        <?php 
			$status = array('Active'=>'Active','Pending'=>'Pending');
echo form_dropdown('category', $status);
