...
<div class="vernav2 iconmenu">
  ...
  <li class="<?php if($active == 'location'|| $active == 'rank'|| $active == 'pin'|| $active == 'branch' ) echo 'current';  ?>"><a href="#Master" class="elements">Master</a> <span class="arrow"></span>
   ...
   <li class="<?php if($active == 'profile'|| $active == 'setting' ) echo 'current';?>"><a href="#Setting" class="drafts ">Setting</a> <span class="arrow"></span>
    ...
    <li class="<?php if($active == 'all_users' || $active == 'new_user' || $active == 'branchs' ) echo 'current';  ?>"><a href="#Users" class="users">Users</a> <span class="arrow"></span>
      <ul id="Users">
     ...
     <li class="<?php if($active == 'agents') echo 'current';  ?>"><a href="#Agents" class="users">Agents</a> <span class="arrow"></span>
      <ul id="Agents">
         <li class="<?php if($active == 'agents') echo 'current'; ?>"><a href="<?php echo base_url('admin/agents')?>">Agent</a></li>
      </ul>
    </li>
    
    <li class="<?php if($active == 'customers') echo 'current';  ?>"><a href="#Customers" class="users">Customers</a> <span class="arrow"></span>
      <ul id="Customers">
